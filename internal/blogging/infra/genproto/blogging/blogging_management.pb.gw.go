...
func request_BloggingManagementService_UpdatePolicies_0(ctx context.Context, marshaler runtime.Marshaler, client BloggingManagementServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq UpdatePoliciesRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := client.UpdatePolicies(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_BloggingManagementService_UpdatePolicies_0(ctx context.Context, marshaler runtime.Marshaler, server BloggingManagementServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq UpdatePoliciesRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := server.UpdatePolicies(ctx, &protoReq)
	return msg, metadata, err
...
func RegisterBloggingManagementServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server BloggingManagementServiceServer) error {
	...
	mux.Handle("PATCH", pattern_BloggingManagementService_UpdatePolicies_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/blogging.BloggingManagementService/UpdatePolicies", runtime.WithHTTPPathPattern("/api/v1/management/policy"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_BloggingManagementService_UpdatePolicies_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_BloggingManagementService_UpdatePolicies_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterBloggingManagementServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client BloggingManagementServiceClient) error {
	...
	mux.Handle("PATCH", pattern_BloggingManagementService_UpdatePolicies_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/blogging.BloggingManagementService/UpdatePolicies", runtime.WithHTTPPathPattern("/api/v1/management/policy"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_BloggingManagementService_UpdatePolicies_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_BloggingManagementService_UpdatePolicies_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"api", "v1", "management", "policy"}, ""))
)
...
var (
	...
	forward_BloggingManagementService_UpdatePolicies_0 = runtime.ForwardResponseMessage
)
